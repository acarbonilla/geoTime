    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grace_period_minutes', models.IntegerField(default=5, help_text='Grace period in minutes before considering late (e.g., 5 minutes)')),
                ('early_login_restriction_hours', models.DecimalField(decimal_places=2, default=1.0, help_text='Hours before scheduled time when early login is allowed (e.g., 1 hour)', max_digits=4)),
                ('require_schedule_compliance', models.BooleanField(default=True, help_text='Whether this employee must comply with scheduled times')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('present', 'Present'), ('absent', 'Absent'), ('late', 'Late'), ('half_day', 'Half Day'), ('leave', 'On Leave'), ('holiday', 'Holiday'), ('weekend', 'Weekend'), ('not_scheduled', '-')], default='not_scheduled', max_length=20)),
