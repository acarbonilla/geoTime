...
def test_manual_approval():
    print("=== Testing Manual Approval Process ===")
    ...
    if pending_request:
        print(f"Testing approval for request {pending_request.id}")
        ...
        if team_leader:
            ...
            request = factory.post(f'/api/time-correction-requests/{pending_request.id}/approve/', {
            ...
            try:
                ...
                print("Testing _apply_time_correction method directly...")
                viewset._apply_time_correction(pending_request)
                ...
                print(f"Found {time_entries.count()} TimeEntry records after direct method call")
                ...
                print(f"Error during direct method call: {str(e)}")
                import traceback
                traceback.print_exc()
        else:
